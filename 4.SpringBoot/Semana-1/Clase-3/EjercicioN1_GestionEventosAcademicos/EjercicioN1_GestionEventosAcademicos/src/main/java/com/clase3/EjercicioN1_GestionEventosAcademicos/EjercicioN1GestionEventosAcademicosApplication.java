package com.clase3.EjercicioN1_GestionEventosAcademicos;

/*
	Ejercicio 1
	-----------
	Estás desarrollando una plataforma para la gestión de eventos académicos en una universidad. El objetivo es crear
	una API RESTful utilizando Java con Spring Boot que permita a los usuarios ver eventos próximos,
	registrar nuevos eventos, inscribir participantes en eventos y obtener detalles específicos de un evento.
...
public class EjercicioN1GestionEventosAcademicosApplication {

	public static void main(String[] args) {
		SpringApplication.run(EjercicioN1GestionEventosAcademicosApplication.class, args);
	}
